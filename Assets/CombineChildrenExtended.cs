	...
	public void Combine()
	{
		...
		foreach (DictionaryEntry de in materialToMesh)
		{
			...
			if (materialToMesh.Count == 1)
			{
				...
				if (Application.isPlaying) filter.mesh.CombineMeshes(instances, generateTriangleStrips);
				else filter.sharedMesh.CombineMeshes(instances, generateTriangleStrips);
